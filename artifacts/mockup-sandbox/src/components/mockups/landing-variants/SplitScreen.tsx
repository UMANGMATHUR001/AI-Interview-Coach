    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col lg:flex-row overflow-hidden font-sans">
      ...
      <div className="w-full lg:w-[55%] flex flex-col justify-center p-8 lg:p-20 xl:p-32 border-b lg:border-b-0 lg:border-r border-white/10">
        <div className="max-w-2xl">
          ...
          <button className="bg-white text-black hover:bg-white/90 transition-colors text-lg font-semibold px-8 py-4 rounded-full w-full sm:w-auto">
            Login
          </button>
        </div>
      </div>
      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-center p-8 lg:p-20 bg-[#0c0c0c]">
        <div className="max-w-xl flex flex-col gap-6">
          {/* Feature 1 */}
          <div className="group flex flex-col p-8 border-l-4 border-indigo-500 bg-white/5 hover:bg-white/[0.07] transition-colors rounded-r-2xl">
          ...
          {/* Feature 2 */}
          <div className="group flex flex-col p-8 border-l-4 border-emerald-500 bg-white/5 hover:bg-white/[0.07] transition-colors rounded-r-2xl">
          ...
          {/* Feature 3 */}
          <div className="group flex flex-col p-8 border-l-4 border-amber-500 bg-white/5 hover:bg-white/[0.07] transition-colors rounded-r-2xl">
